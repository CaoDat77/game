      ...
      <Container fluid className={styles.bg}>
        <Container className={styles.Breadcrumbs}>
          <Breadcrumb>
            ...
            <Breadcrumb.Item active>Living Room</Breadcrumb.Item>
          </Breadcrumb>
        </Container>
      </Container>
          ...
          <Row>
              ...
              <Swiper {...swiperProps}>
                <SwiperSlide>
                  <img
                    ...
                    src="/project/livingroom/pic-1.jpg"
                    alt=""
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
                    className={styles.img}
                    src="/project/livingroom/pic-2.jpg"
                    alt=""
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
                    className={styles.img}
                    src="/project/livingroom/pic-3.jpg"
                    alt=""
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
                    className={styles.img}
                    src="/project/livingroom/pic-4.jpg"
                    alt=""
                  />
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <img
                    className={styles.img}
                    src="/project/livingroom/pic-5.jpg"
                    alt=""
                  />
                </SwiperSlide>
              </Swiper>
            ...
            <Col lg={5}>
              <div className={styles.info}>
                <h1 className={styles.name}>white design</h1>
                ...
                <div className={styles.tag}>
                  ...
                  <p>
                    <b>CATEGORY : </b> <i> INTERIOR LIVING ROOM</i>
                  </p>
                  <p>
                    <b>TAG : </b>
                    <i> White Living Room</i>
                  </p>
                </div>
              </div>
            </Col>
